...
const collectibles = {
    ...
    cat: {
        ...
        itemNames: ['Fluffy', 'Mittens', 'Whiskers', 'Mochi', 'Pumpkin', 'Shadow', 'Luna', 'Oreo', 'Biscuit', 'Noodle'],
        itemDescriptions: [
            'Friendly lap cat who purrs on contact and follows you room to room.',
            'Affectionate and gentle, always ready for head boops and slow blinks.',
            'Curious social butterfly who investigates everything, including your keyboard.',
            'Sweet but selective, cuddly on schedule and bossy before breakfast.',
            'Playful goofball with zoomies at night and dramatic meows for treats.',
            'Distant observer who keeps a cool vibe but secretly watches over everyone.',
            'Quiet, loving shadow cat who appears exactly when you need comfort.',
            'Moody diva who switches from cuddles to side-eye in under three seconds.',
            'Food-motivated charmer, friendly when snacks appear and opinionated when late.',
            'Tiny chaos gremlin: curious, clingy, and occasionally angry about closed doors.'
        ],
    ...
    dog: {
        ...
        itemDescriptions: [
            'Friendly greeter who treats every visitor like a long-lost best friend.',
            'Loyal sidekick that sticks close and checks on you every ten minutes.',
            'High-energy athlete who loves fetch, zoomies, and backyard patrols.',
            'Gentle sweetheart with patient manners and unlimited cuddle stamina.',
            'Soft-hearted cuddle pup who naps hard and loves belly rubs.',
            'Smart observer who learns routines quickly and waits by the door on time.',
            'Confident protector with a big bark and an even bigger heart.',
            'Playful clown who turns ordinary walks into full comedy routines.',
            'Big softie who looks tough but melts instantly for affection.',
            'Goofy charmer with expressive eyes and a permanent wagging tail.'
        ],
...
'https://cdn-icons-png.flaticon.com/128/2663/2663100.png'
        ...
        itemNames: ['Cotton', 'Cinnamon', 'Bramble', 'Dusty', 'Clover', 'Poppy', 'Willow', 'Nutmeg', 'Thistle', 'Honey'],
        itemDescriptions: [
            'Soft and friendly, happiest when gently pet and offered leafy snacks.',
            'Curious explorer who sniffs everything before deciding it is safe.',
            'Shy at first, then suddenly zooms around with happy bunny binkies.',
            'Calm cuddle bunny who prefers cozy corners and quiet company.',
            'Playful and social, always first to hop over for attention.',
            'Energetic little hopper with nonstop curiosity and tiny dramatic pauses.',
            'Gentle soul who likes routine, soft voices, and tidy hideouts.',
            'Snack detective who can hear a treat bag from across the room.',
            'Independent but affectionate, asks for love on bunny-approved timing.',
            'Sweet and trusting, follows you around once you earn friendship.'
        ],
...
'https://cdn-icons-png.flaticon.com/128/534/534691.png'
        ...
        itemNames: ['Teddy', 'Bruno', 'Honey', 'Grizzle', 'Panda', 'Fuzzy', 'Cocoa', 'Marshmallow', 'Smokey', 'Snickers'],
        itemDescriptions: [
            ...
            'Honey finds golden treats by the buzzing bees. Honey hums with delight in the morning light.',
            'Grizzle has a mighty roar by the river shore. Grizzle chills in the sun when the day is done.',
            'Panda munches bamboo all day at the zoo. Panda rolls with cheer from ear to ear.',
            'Fuzzy wears a fluffy coat that feels like a boat. Fuzzy bounces in place with a smiley face.',
            'Cocoa sips warm dreams by moonlit streams. Cocoa curls up tight every cozy night.',
            'Marshmallow is sweet as snow with a gentle glow. Marshmallow floats around without a sound.',
            'Smokey wanders the trail at a calm, cool scale. Smokey waves hello where the pine winds blow.',
...
'https://cdn-icons-png.flaticon.com/128/1635/1635928.png'
        ...
        itemNames: ['Rio', 'Sky', 'Kiwi', 'Sunny', 'Blue', 'Finch', 'Chirpy', 'Hoot', 'Lovebirds', 'Mango'],
        itemDescriptions: [
            'Loves fruit-heavy snacks and shows off glossy plumage with flashy little hops.',
            'Prefers seeds and tender shoots, then performs looping flight displays to impress.',
            'Forages for insects in short bursts and keeps feathers neat for courtship season.',
            'Enjoys berries at sunrise and uses bright chest feathers in partner dances.',
            'Snacks on grains and tiny bugs, with iridescent tones that shimmer in sunlight.',
            'Specialist seed-eater with crisp feather patterns and a rapid courtship song.',
            'Eats soft fruits and nectar, then fluffs up plumage during excited mate calls.',
            'Nocturnal hunter with silent feathers, plus deep hoots used for territorial and mating signals.',
            'Feeds in bonded pairs, preens each other constantly, and seals romance with synchronized chirps.',
            'Loves sweet fruit and vivid plumage, finishing courtship with playful head-bobs.'
        ],
...
'https://cdn-icons-png.flaticon.com/128/1660/1660713.png'
        ...
        itemNames: ['Pebble', 'Pingu', 'Waddle', 'Frosty', 'Biscuit', 'Tux', 'Ice', 'Splash', 'Noodle', 'Bubbles'],
        itemDescriptions: [
            ...
            'Tap-tap, Waddle marches in tiny steps with maximum confidence.',
            'Brrr-brrr, Frosty shivers theatrically even when it is not that cold.',
            'Chomp-chomp, Biscuit never says no to a crunchy fishy snack.',
            'Flap-flap, Tux gives a formal wing wave before every belly slide.',
            'Skrrt-skrrt, Ice glides past like a tiny penguin race car.',
            'Splish-splash, Splash turns every puddle into a personal water park.',
            'Slurp-slurp, Noodle tackles dinner noodles like a champion.',
...
'https://cdn-icons-png.flaticon.com/128/1635/1635937.png'
        ...
        itemNames: ['Rusty', 'Ember', 'Maple', 'Copper', 'Ginger', 'Scarlet', 'Autumn', 'Blaze', 'Flame', 'Auburn'],
        itemDescriptions: [
            ...
            'Prefers sweet apples and fallen pears from the edge of the orchard.',
            ...
            'Loves fresh eggs from unattended nests and never leaves crumbs.',
            'Favorite meal is a plump vole, preferably chased through autumn leaves.',
            'Will pick chicken scraps over fancy meals every single time.',
...
'https://cdn-icons-png.flaticon.com/128/1717/1717864.png'
        ...
        itemNames: ['Turtle', 'Whale', 'Crab', 'Star', 'Clownie', 'Jelly', 'Shark', 'Urchin', 'Pearl', 'Shrimp'],
        itemDescriptions: [
...
'https://cdn-icons-png.flaticon.com/128/688/688343.png'
        ...
        itemNames: ['Flutter', 'Mariposa', 'Sky', 'Shimmer', 'Willow', 'Pearl', 'Zephyr', 'Dusty', 'Moonbeam', 'Blossom'],
        itemDescriptions: [
...
'https://cdn-icons-png.flaticon.com/128/3142/3142825.png'
        ...
        itemNames: ['Boba', 'Baby Drink', 'Lightning', 'Redblue', 'Water', 'Coke', 'Milkeshake', 'Coconut', 'Orange Juice', 'Juice Box'],
        itemDescriptions: [
...
'https://cdn-icons-png.flaticon.com/128/2880/2880203.png'
        ...
        itemNames: ['Rose', 'Cherry Blossoms', 'Blueblue', 'Yellow', 'Flower Basket', 'Rainbow', 'Sunny Flower', 'Cherry Bonsai', 'Violets', 'Sunny Earth'],
        itemDescriptions: [
...
'https://cdn-icons-png.flaticon.com/128/9053/9053615.png'
        ...
        itemNames: ['Red Cap', 'Spotted', 'Purple Shroom', 'Golden', 'Blue Magic', 'Enoki', 'Shiitake', 'Button', 'Chanterelle', 'Oyster'],
        itemDescriptions: [
            'Classic dome cap with bold color, like a storybook forest mushroom.',
            'Speckled cap pattern that stands out like natural camouflage in reverse.',
            'Velvety tones and whimsical color, giving this mushroom a magical woodland vibe.',
            'Warm golden cap with a rich look often linked to prized wild fungi.',
            'Cool-toned and unusual, with a rare, enchanted look among mushrooms.',
            'Long, slender stems that grow in clusters and look delicate but springy.',
            'Broad, earthy cap known for a deep umami character and sturdy texture.',
            'Small, rounded shape that is simple, familiar, and easy to love.',
            'Ruffled, trumpet-like edges with a foraged look and elegant folds.',
            'Fan-shaped layers that resemble oyster shells stacked on wood.'
        ],
...
'https://cdn-icons-png.flaticon.com/128/2363/2363876.png'
        ...
        itemDescriptions: [
            ...
            'Nyxion burns in cool tones and is brightest during deep night skies.',
            'Solari shines hot and bold, like a miniature sunrise in space.',
            'Astrell sparkles in sharp flashes, as if blinking in cosmic code.',
            'Lumora has a gentle radiance that makes nearby stars look softer.',
            ...
            'Vireon glints in vibrant waves, shifting brightness as it turns.',
...
'https://cdn-icons-png.flaticon.com/128/2634/2634269.png'
        ...
        itemDescriptions: [
            'Debbie sparkles brighter whenever someone tells a dramatic story nearby.',
            'Randy hums softly at midnight like a tiny disco ball with secrets.',
            'Tammy changes shade depending on the snack currently in your hand.',
            ...
            'Kevin looks calm by day but throws glittery tantrums under neon light.',
            'Lisa reflects tiny starbursts that look suspiciously like confetti.',
